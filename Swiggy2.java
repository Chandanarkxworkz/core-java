class Swiggy2 {
	...
	if(foodName == "papdi chaat"){
	price= 35.00;
	return price; 
	
	}
	if(foodName == "poha jalebi"){
	price = 40.15;
	return price; 
	...
	if(foodName == "sushi"){
	price=249.70*quantity;
	return price; 
	
	}
	if(foodName == "pav bhaji"){
	price =100.90*quantity;
	return price; 
	
	}
	if(foodName == "bhel puri"){
	price =50.10*quantity;
	return price; 
	...
	if(foodName == "khasta kachori"){
	price = 40.25*quantity;
	return price; 
	
	}
	if(foodName == "dabeli"){
	price= 25.10*quantity;
	return price; 
	...
	if(foodName == "pulao"){
	price = 60.25*quantity;
	return price; 
	
	}
	if(foodName == "kashmiri naan"){
	price = 120.10*quantity;
	return price; 
	
	}
	if(foodName == "mattar paneer"){
	price = 110.75*quantity;
	return price; 
	
	}
	if(foodName == "rajma"){
	price = 80.70*quantity;
	return price; 
	...
	if(foodName == "rumali roti"){
	price = 49.30*quantity;
	return price; 
	
	}
	if(foodName == "dessert"){
	price = 249.45*quantity;
	return price; 
	
	}
	if(foodName == "misal"){
	price = 99.80*quantity;
	return price; 
	
	}
	if(foodName == "raita"){
	 price = 200.15*quantity;
	 return price; 
	}
	System.out.println("end of search");
	return price;
